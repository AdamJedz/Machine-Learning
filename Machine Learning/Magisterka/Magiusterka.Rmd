...
dataset %>% 
  ...
  labs(title = "10 najbardziej płodnych reżyserów",
       x = "Reżyser",
       y = "Ilość filmów")+
  theme(legend.position = "none") +
  theme(plot.title = element_text(hjust = .5),
...
dataset %>% 
  ...
  labs(title = "Rozkłąd wartości ocen użytkowników portalu Metacritic",
       y = "Ilość",
       x = "Ocena") +
  theme(plot.title = element_text(hjust = .5))
```
...
dataset %>% 
  ...
  labs(title = "Rozkład ocen recenzentów portalu Rotten Tomatoes",
       y = "Ilość",
       x = "Ocena") +
  theme(plot.title = element_text(hjust = .5))
```
...
dataset %>% 
  ...
  labs(title = "Rozkład wartości zmienej Meter",
       y = "Ilość",
...
dataset %>% 
  ...
  labs(title = "Rozkład wartości ocen użytkowników portalu Rotten Tomatoes",
       y = "Ilość",
       x = "Ocena") +
  theme(plot.title = element_text(hjust= .5))
```
...
dataset %>% 
  ...
  labs(title = "Zależność wyniku finansowego od oceny z IMDB",
       subtitle = "Wartośc wyniku finansowego przedstawiona jest w skali logarytmicznej",
       x = "Ocena z IMDB",
       y = "Wynik finansowy") +
  theme(plot.title = element_text(hjust = .5))
```
